...
export const metadata = pageMetadata(PAGE_SEO.servicii);
  ...
  return (
    <main className="bg-zinc-950 text-white">
      <JsonLd
        data={[
          webPageSchema({
            path: PAGE_SEO.servicii.path,
            name: `${PAGE_SEO.servicii.title} · ZeroBug`,
            description: PAGE_SEO.servicii.description,
            type: "CollectionPage",
          }),
          breadcrumbSchema([
            { name: "Acasă", path: "/" },
